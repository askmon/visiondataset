		...
		<tiles:insertDefinition name="templateVisionDataset">
			<tiles:putAttribute name="content">
				...
				<div class="section">
					...
					<s:form action="AnnotateImage" focusElement="AnnotateImage_tagName"
						onsubmit="getAnnotationCoords('AnnotateImage');">
			...
			<tiles:putAttribute name="pageScript">
				$(document).ready(
					function() {
						...
						autocomplete("#AnnotateImage_tagName", tags);
						...
						$("div.annotation").effect("highlight", {}, 1000);
